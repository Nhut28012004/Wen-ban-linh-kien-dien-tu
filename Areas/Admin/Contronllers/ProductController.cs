...
namespace QLBH.Areas.Admin.Contronllers
{
    ...
    public class ProductController : Controller
    {
        ...
        public async Task<IActionResult> AddQuantity(int Id)
        {
            ...
            var model = new ProductQuantityModel { ProductId = Id };
            return View(model);
        }
        ...
        public async Task<IActionResult> StoreProductQuantity(ProductQuantityModel productQuantityModel)
        {
            ...
            // Use ProductId (not Quantity) to find the product
            ...
            // Increase product quantity by the provided amount
            product.Quantity += productQuantityModel.Quantity;

            // Ensure the productQuantityModel has the correct ProductId and timestamp
            productQuantityModel.ProductId = product.Id;
            productQuantityModel.DateCreated = DateTime.Now;

            await _dataContext.AddAsync(productQuantityModel);
            await _dataContext.SaveChangesAsync();

            _dataContext.Add(productQuantityModel);
            _dataContext.SaveChangesAsync();
            TempData["success"] = "Thêm số lượng sản phẩm thành công";
            return RedirectToAction("AddQuantity", "Product", new { Id = productQuantityModel.Quantity });
        }
    }
}
