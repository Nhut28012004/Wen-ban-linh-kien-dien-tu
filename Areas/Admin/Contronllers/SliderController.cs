...
namespace QLBH.Areas.Admin.Controllers
{
    ...
    public class SliderController : Controller
    {
        ...
        public async Task<IActionResult> Create(SliderModle slider)
        {
        ...
        {
            SliderModle slider = await _dataContext.Sliders.FindAsync(Id);
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(SliderModle slider)
        {
